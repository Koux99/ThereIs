...
現在、デプロイは行っておりません。以前に、AWSにデプロイしていた際の情報となりますことご了承ください。
Webサイトのイメージにつきましては、以下機能紹介にてご確認いただければと存じます。
...
それなら、自分がリソースになってひとまとめにしていこう！
という勝手に湧き出た使命感から今回このアプリを作成することにしました。

ジャンルは限られますし、情報収集も単独パワープレイになりますが、これまで調べてきたたくさんの情報をこのサイトにてご紹介し、
皆さんと一緒に視野をもっともっと広げて行けたらと思い、日々楽しく情報を集めています。

ニュース記事ほど長くない文章なので、空いた時間にサクッと読んでいただき、
